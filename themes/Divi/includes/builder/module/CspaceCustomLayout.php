...
class Cspace_ET_Builder_Module_Layout extends ET_Builder_Module_Type_PostBased {
	function init() {
		$this->name       = esc_html__( 'Cspace Layout', 'et_builder' );
		$this->slug       = 'et_pb_cspace_layout';
		...
		$this->fields_defaults = array(
			'fullwidth'         => array( 'on' ),
			'posts_number'      => array( 20, 'add_default_setting' ),
			'show_title'        => array( 'on' ),
...
new Cspace_ET_Builder_Module_Layout;
